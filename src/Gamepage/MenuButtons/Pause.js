...
const Pause = ({onPlayerClick}) => {
  return (
<svg className="menubtn" width="334px" height="446px" viewBox="0 0 334 446" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" onClick={onPlayerClick}>
